set_size_only [get_cell -hier *size_only_inst* ]
set_dont_touch [get_nets -hier *_out ]
...
create_clock -name "pwrctl_clk" -period $rclk_period pwrctl_clk
...
source -echo -verbose ../../constraints/fifo1_top.upf
} else {
read_power_intent ../../constraints/fifo1_top.upf -version 2.1 -module $top_design -1801
  apply_power_intent
   commit_power_intent
