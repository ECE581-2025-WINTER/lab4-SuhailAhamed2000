...
#		    source ../../syn/outputs/ORCA.dc.upf
		...
		foreach scenario { {func_worst func Cmax } {func_best func Cmin} {test_worst test Cmax} {test_best test Cmin} } {
		  ...
		  source -echo -verbose -continue_on_error ../../constraints/ORCA_[lindex $scenario 0 ].sdc 
...
#        	source ../../constraints/ORCA.upf
   ...
   read_power_intent ../../constraints/ORCA.upf -version 2.0 -module $top_design -1801
   apply_power_intent
   commit_power_intent
#   report_power_intent 
   set_units -time ns
